        ...
        <v-card rounded="xl" class="form-card">
          <v-card-title class="form-header px-6 pt-6 pb-2">
            <div>
              ...
              <h2 class="form-title">Renew Subscription</h2>
              <p class="form-subtitle mb-0">Extend subscription period with a new payment.</p>
            </div>
          </v-card-title>

          <v-card-text class="px-6 pb-6 pt-3">
            <v-form ref="renewSubscriptionForm" @submit.prevent="renewSubscription">
              <v-row>
                <v-col cols="12" sm="6">
                ...
                <v-col cols="12" class="d-flex flex-wrap action-wrap">
                  <v-btn variant="tonal" color="#ff6692" rounded="lg" class="text-none" @click="cancelRenewSubscription">Cancel</v-btn>
